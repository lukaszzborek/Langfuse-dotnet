...
app.MapPost("/chat-completion", async ([FromServices] ActivitySource activitySource, [FromBody] ChatCompletionRequest request) =>
{
    try
    {
...
app.MapPost("/text-completion", async ([FromServices] ActivitySource activitySource, [FromBody] TextCompletionRequest request) =>
{
    try
    {
...
app.MapPost("/function-calling", async ([FromServices] ActivitySource activitySource, [FromBody] FunctionCallingRequest request) =>
{
    try
    {
        var config = new GenAiChatCompletionConfig
...
app.MapPost("/conversation", async ([FromServices] ActivitySource activitySource, [FromBody] ConversationRequest request) =>
{
    try
    {
