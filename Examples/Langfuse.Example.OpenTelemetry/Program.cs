...
// New endpoint to run the parallel summarization example
app.MapPost("/run-parallel-summary",
    async ([FromServices] ParallelSummarizationService parallelService) =>
    {
        try
        {
            var articlesToSummarize = new List<Article>
            {
                new()
                {
                    ...
                    Content =
                        "The role of artificial intelligence in revolutionizing medical diagnostics and patient care is growing rapidly...",
                    Keywords = "AI, Healthcare, Diagnostics"
                },
                new()
                {
                    Id = 2, Title = "Quantum Computing Future",
                    Content =
                        "Quantum computing promises to solve problems currently intractable for classical computers, impacting cryptography and materials science...",
                ...
                new()
                {
                    ...
                    Content =
                        "Innovations in solar, wind, and geothermal energy are key to combating climate change and ensuring a sustainable future...",
