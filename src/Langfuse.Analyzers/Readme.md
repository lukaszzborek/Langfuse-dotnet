...
### Langfuse.Analyzers.Sample

A project that references the sample analyzers. Note the parameters of `ProjectReference`
in [Langfuse.Analyzers.Sample.csproj](../Langfuse.Analyzers.Sample/Langfuse.Analyzers.Sample.csproj), they make sure
that the project is referenced as a set of analyzers.

### Langfuse.Analyzers.Tests
