...
/// <summary>
///     Request for creating a new score in Langfuse. Scores are evaluation measurements that can be attached to traces, observations, or sessions.
/// </summary>
public class ScoreCreateRequest
{
    ...
    /// <summary>
    ///     ID of the observation this score belongs to. Required unless traceId is provided. Used for observation-level evaluations.
    /// </summary>
    ...
    /// <summary>
    ///     Name identifying the type of score (e.g., "quality", "relevance", "toxicity"). Must match a score configuration if one exists.
    /// </summary>
    [JsonPropertyName("name")]
    public required string Name { get; set; }

    /// <summary>
    ///     The score value. Can be a number (for numeric scores), string (for categorical), or boolean. Type should match the data type configuration.
    /// </summary>
    ...
    /// <summary>
    ///     ID of the score configuration to validate this score against. Ensures the score follows predefined rules and categories.
    /// </summary>
