...
public class CreateEventBody : IDisposable
{
    ...
    /// <summary>
    ///     The level of the event. Used for sorting/filtering of traces with elevated error levels and for highlighting in the
    ///     UI
    /// </summary>
    ...
    /// <summary>
    ///     The status message of the event. Additional field for context of the event. E.g. the error message of an error
    ///     event
    /// </summary>
