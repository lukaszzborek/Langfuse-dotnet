...
namespace zborek.Langfuse.Models.Health;

/// <summary>
///     Response from the Langfuse health check endpoint, providing system status and version information for monitoring
///     and diagnostics.
/// </summary>
