...
/// <summary>
///     Request to create a new comment in Langfuse. Comments provide a way to annotate and collaborate on traces,
...
public class CreateCommentRequest
{
    ...
    /// <summary>
    ///     The unique identifier of the object to attach the comment to. Must reference a valid existing object or an error
    ///     will be thrown.
    /// </summary>
    ...
    /// <summary>
    ///     The text content of the comment. Supports Markdown formatting for rich text. Currently limited to 3000 characters
    ///     maximum.
    /// </summary>
