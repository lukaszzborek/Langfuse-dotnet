...
/// <summary>
///     Represents a dataset run with its associated items - an experimental execution of a dataset for evaluation
///     purposes.
///     Dataset runs track how your LLM application performs against a specific set of test cases, enabling systematic
...
public class DatasetRunWithItems
{
    ...
    /// <summary>
    ///     Additional metadata associated with the dataset run as a JSON object, containing experiment parameters and
    ///     configuration.
    /// </summary>
...
/// <summary>
///     Represents a single execution item within a dataset run - links a dataset item to its corresponding
