...
/// <summary>
///     Generic base class for paginated API responses from Langfuse. Provides consistent structure for responses containing multiple items with pagination metadata.
/// </summary>
