...
/// </summary>
public class CreateGenerationEventBody
{
    /// <summary>
    /// Time provider
    /// </summary>
    ...
    /// <summary>
    /// The time at which the completion started (streaming). Set it to get latency analytics broken down into time until completion started and completion duration
    /// </summary>
    ...
    /// <summary>
    /// The level of the generation. Used for sorting/filtering of traces with elevated error levels and for highlighting in the UI
    /// </summary>
    [JsonPropertyName("level")]
    public LangfuseLogLevel Level { get; set; } = LangfuseLogLevel.Default;
    
    /// <summary>
    /// The status message of the generation. Additional field for context of the event. E.g. the error message of an error event
    /// </summary>
    ...
    /// <summary>
    /// The version of the generation type. Used to understand how changes to the span type affect metrics. Useful in debugging
    /// </summary>
    ...
    /// <summary>
    /// The usage object supports arbitrary usage types with their units of consumption. Refer to the docs on how to automatically infer token usage and costs in Langfuse
    /// </summary>
    [JsonPropertyName("usage")]
    public object? Usage { get; private set; }

    /// <summary>
    /// The cost object supports arbitrary cost types with their units of consumption. Refer to the docs on how to automatically infer token usage and costs in Langfuse
    /// </summary>
