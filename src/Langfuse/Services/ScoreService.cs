...
/// <summary>
///     Implementation of score service for Langfuse API
/// </summary>
internal class ScoreService : IScoreService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var result = JsonSerializer.Deserialize<ScoreListResponse>(responseContent, SerializerOptions);
    ...
    /// <inheritdoc />
    public async Task<Score> GetAsync(string scoreId, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var responseContent = await response.Content.ReadAsStringAsync(cancellationToken);
            var result = JsonSerializer.Deserialize<Score>(responseContent, SerializerOptions);
    ...
    /// <inheritdoc />
    public async Task<Score> CreateAsync(ScoreCreateRequest request, CancellationToken cancellationToken = default)
    {
        if (request == null)
        {
    ...
    /// <inheritdoc />
    public async Task DeleteAsync(string scoreId, CancellationToken cancellationToken = default)
    {
        if (string.IsNullOrWhiteSpace(scoreId))
        {
            throw new ArgumentException("Score ID cannot be null or empty", nameof(scoreId));
    ...
    private static async Task EnsureSuccessStatusCodeAsync(HttpResponseMessage response)
    {
        ...
        {
            HttpStatusCode.NotFound => "The requested score was not found",
            ...
            HttpStatusCode.Conflict => "Score already exists or conflict with existing data",
